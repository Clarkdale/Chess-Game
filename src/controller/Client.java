...
public class Client extends Application {
	...
	private void renderGame() {
		bobbyFisher = new Piece [8][8];
		
		bobbyFisher[0][0] = new Rook(0, 0, turn, false);
		bobbyFisher[0][1] = new Knight(1, 0, turn, false);
		bobbyFisher[0][2] = new Bishop(2, 0, turn, false);
		bobbyFisher[0][3] = new 
		...
		for (int i = 0; i < 8; i++) {
			for (int j = 0; j < 8; j++) {
				if (bobbyFisher[i][j] != null) {
					...
					//TODO: Implement flyweight class based on url returned from piece classes
